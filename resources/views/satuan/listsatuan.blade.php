    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Satuan</h4>
                    </div>
                </div>
            </div>
        </div>
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-center mb-0" id="SatuanList">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('satuan/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#SatuanList').DataTable({
                processing: true,
                serverSide: true,
                ordering: true,
                searching: false,
                ajax: {
                    url: "{{ route('get-satuan-data') }}",
                    data: function(d) {
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
            ...
            $('#SatuanList tbody').on('mouseenter', 'tr', function() {
                $(this).css('cursor', 'pointer');
            });

            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.satuan_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
            ...
            $('#SatuanList tbody').on('click', 'tr', function(e) {
                ...
                if (data) {
                    window.location.href = "/satuan/edit/" + data.id;
                }
            });
        });
    </script>
