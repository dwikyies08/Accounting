    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Kategori Barang</h4>
                    </div>
                </div>
            </div>
        </div>
...
<<<<<<< HEAD
                <div class="card rounded-default p-3 bg-dark text-white">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control key-filter" placeholder="Nama Kategori">
                    </div>
=======
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-center mb-0" id="KategoriBarangList">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('kategoribarang/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#KategoriBarangList').DataTable({
                processing: true,
                serverSide: true,
                ordering: true,
                searching: false,
                ajax: {
                    url: "{{ route('get-kategoribarang-data') }}",
                    data: function(d) {
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
            ...
            $('#select_all').on('click', function() {
                $('.kategori_barang_checkbox').prop('checked', this.checked);
            });

            $('#KategoriBarangList tbody').on('mouseenter', 'tr', function() {
                $(this).css('cursor', 'pointer');
            });

            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.kategori_barang_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
                ...
                if (selectedIds.length > 0) {
                    if (confirm('Apakah yakin ingin menghapus data yang dipilih?')) {
                        $.ajax({
                            url: "{{ route('kategoribarang/delete') }}",
                            type: "POST",
                            data: {
                                ids: selectedIds,
                                _token: "{{ csrf_token() }}"
            ...
            $('#KategoriBarangList tbody').on('click', 'tr', function(e) {
                ...
                if (data) {
                    window.location.href = "/kategoribarang/edit/" + data.id;
                }
            });
        });
    </script>
