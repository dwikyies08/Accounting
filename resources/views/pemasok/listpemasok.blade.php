    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-2">Data Pemasok</h4>
                    </div>
                </div>
            </div>
        </div>
...
<<<<<<< HEAD
                <div class="card rounded-default p-3 bg-dark text-white">
                    <div class="form-group">
                        ...
                        <input type="text" name="pemasok_id" class="form-control key-filter" placeholder="Cari berdasarkan ID">
                    </div> 
                    <div class="form-group">
                        <input type="text" name="nama" class="form-control key-filter" placeholder="Nama Pemasok">
                    </div>
                    <div class="form-group">
                        <label>Mata Uang</label>
                        <select class="form-control click-filter" name="mata_uang">
...
=======
                <div class="card rounded-default p-3 filterBox text-white">
                    <form method="GET" action="{{ route('pemasok/list/page') }}">
                        <div class="form-group mb-1">
                            <label>Pencarian</label>
                            <input type="text" name="pemasok_id" class="form-control form-control-sm" onchange="this.form.submit()" placeholder="Cari berdasarkan ID" value="{{ request('pemasok_id') }}">
                        </div> 
                        <div class="form-group mb-1">
                            <input type="text" name="nama" class="form-control form-control-sm" onchange="this.form.submit()" placeholder="Nama Pemasok" value="{{ request('nama') }}">
                        </div>
                        <div class="form-group mb-1">
                            <label>Mata Uang</label>
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-center mb-0" id="PemasokList">
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('pemasok/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#PemasokList').DataTable({
                processing: true,
                serverSide: true,
                ordering: true,
                searching: false,
                ajax: {
                    url: "{{ route('get-pemasok-data') }}",
                    data: function(d) {
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
            ...
            $('#select_all').on('click', function() {
                $('.pemasok_checkbox').prop('checked', this.checked);
            });

            $('#PemasokList tbody').on('mouseenter', 'tr', function() {
                $(this).css('cursor', 'pointer');
            });

            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.pemasok_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
            ...
            $('#PemasokList tbody').on('click', 'tr', function(e) {
