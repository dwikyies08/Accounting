...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-center mb-0" id="PenjualList">
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
                ...
                <div class="page-header">
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <a href="{{ route('penjual/add/new') }}" class="btn btn-primary float-left veiwbutton"><i class="fas fa-plus mr-2"></i>Tambah</a>
...
@section('script')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#PenjualList').DataTable({
                processing: true,
                serverSide: true,
                ordering: true,
                searching: false,
                ajax: {
                    url: "{{ route('get-penjual-data') }}",
                    data: function(d) {
                        d.nama_depan_penjual = $('input[name=nama_depan_penjual]').val(),
...
>>>>>>> 8aec55e85e9d6a9b53b74c0e47ea6990ac3bf94a
            ...
            $('#select_all').on('click', function() {
                $('.penjual_checkbox').prop('checked', this.checked);
            });

            $('#PenjualList tbody').on('mouseenter', 'tr', function() {
                $(this).css('cursor', 'pointer');
            });

            $('#deleteSelected').on('click', function() {
                var selectedIds = $('.penjual_checkbox:checked').map(function() {
                    return $(this).val();
                }).get();
            ...
            $('#PenjualList tbody').on('click', 'tr', function(e) {
                ...
                var data = table.row(this).data();
                    if (data) {
                        window.location.href = "/penjual/edit/" + data.id;
                    }
            });
        });
    </script>
