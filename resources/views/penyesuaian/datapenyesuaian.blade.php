                ...
                <div class="card rounded-default p-3 filterBox text-white">
                    <form method="GET" action="{{ route('penyesuaian/list/page') }}">
                        ...
                        <div class="form-group mb-1">
                            <label>Pencarian</label>
                            <input type="text" name="no_penyesuaian" class="form-control form-control-sm" onchange="this.form.submit()" placeholder="Cari berdasarkan ID" value="{{ request('no_penyesuaian') }}">
                        </div>
                        <div class="form-group mb-1">
                        ...
                        <div class="form-group mb-1">
                            <label>Rentang Tanggal</label>
                            <input type="text" class="form-control form-control-sm datetimepicker mb-1" name="tgl_mulai" value="{{ request('tgl_mulai') }}"> 
                            <input type="text" class="form-control form-control-sm datetimepicker" onchange="this.form.submit()" name="tgl_sampai" value="{{ request('tgl_sampai') }}">
                        </div>
                        <div class="form-group mb-1">
                            <label>Dihentikan</label><br>
