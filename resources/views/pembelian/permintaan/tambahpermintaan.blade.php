...
<<<<<<< HEAD
                                                                <th style="padding: 4px; text-align: center;"><input type="checkbox" id="checkAll"></th>
=======
                    ...
                    <div class="mb-15 row align-items-center">
                        <div class="col">
                            <div class="">
                                ...
                                <a href="{{ route('pembelian/permintaan/list/page') }}" class="btn btn-primary float-left veiwbutton ml-3"><i class="fas fa-chevron-left mr-2"></i>Batal</a>
                            </div>
                        </div>
                    </div>
                </div>
